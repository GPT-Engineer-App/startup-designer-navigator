...
**Project**: startup-designer-navigator 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: I need to discover the best designers at the best emerging startups.

Build me a tool to list emerging startups where I can filter them by team size and location, and easily view their website and linkedin. 
...
```sh
git clone https://github.com/GPT-Engineer-App/startup-designer-navigator.git
cd startup-designer-navigator
npm i
